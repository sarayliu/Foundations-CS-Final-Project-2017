...
public class Gameboard1 extends JPanel
{
   ...
   private OnePlayerScoreboard oneScoreboard;   // Class variable for OnePlayerScoreboard class
   
   public Gameboard1(String word, int hangtype) //Gameboard1 constructor
   {
      oneScoreboard = new OnePlayerScoreboard();   
      add(oneScoreboard, BorderLayout.NORTH);      
      ...
      northSubpanel.add(oneScoreboard);            // Add OnePlayerScoreboard to JPanel
      ...
      public void actionPerformed(ActionEvent e)
      {
         if(numParts() == true)//If game is still in play...
         {
            ...
            if(numRight == word1.length())//If the complete word is guessed correctly...
            {
               ...
               oneScoreboard.winIncrease();     // Increment the Win streak by 1
               oneScoreboard.perUpdate();       // Update Win streak display
            }
         } 
         else//If user has lost the game...
         {
            ...
            reset.setEnabled(true); //Allow the user to restart the game
            enter.setEnabled(false);
            oneScoreboard.lostStreak();      // Reset Win Streak to zero
            oneScoreboard.perUpdate();       // Update Win streak display
         }
      }
   }
   private class resetListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ...
         try
         {
            ...
            word1 = words.get(random);//Obtain a new word from words.txt
            ...
            showLetter(word1, textbox);//Allow the user to guess letters
